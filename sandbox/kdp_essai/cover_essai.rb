...
Prawn::Document.generate(
  File.join(__dir__, "cover_essai.pdf"),
...
puts "cover_essai.pdf généré — #{KDP_CALC.cover_width.round(4)}in x #{KDP_CALC.cover_height.round(4)}in, dos #{KDP_CALC.spine_width.round(4)}in"
